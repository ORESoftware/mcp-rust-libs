...
- `ore-mcp-org-server`: a 15-tool read-only server with organization-derived resources/prompts, all eight provider adapters, final-protocol stdio, and Shared Auth protected Streamable HTTP for the six required client families;
